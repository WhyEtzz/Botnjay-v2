...
const whatsapplu = 'https://wa.me/+6285755495437'; // Nomor whatsapplu cok
const kapanbotaktif = 'Kalo mood'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/?'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://bit.ly/butuhsabun'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
if (text.includes("-sholat")){
  ...
  conn.sendMessage(id, '[ WAIT ] proses kak⌛', MessageType.text)
...
const get = require('got')
    ...
    conn.sendMessage(id,`DATA WABAH COVID-19 TERBARU DI INDONESIA\n\n🔰Positif ➡️ ${positif} \n🔰Sembuh ➡️ ${sembuh} \n🔰Meninggal ➡️ ${meninggal}\n🔰Dirawat ➡️ ${dirawat}`, MessageType.text);
}
...
if (text.includes("-neko"))
   {
    var items = ["kucing imut hd", "kucing ganteng hd", "kucing lucu hd", "kucing hd"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
   ...
   {
    var items = ["cowo ganteng", "cogan", "cowo badass", "us male actor", "Cogan cool","jamet"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
